...
<body>
	<div class="text-center alert container alert-danger alert-dismissible fade show align-self-center" role="alert">
	  <strong style="font-size: x-large">아이디와 이메일을 다시 확인해주세요.</strong>
	  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" onClick="location.href='findPwForm'"></button>
	</div>
