...
<%-- 	<a href="<c:url value='aaa'/>">회원 정보 확인</a><br>
	<a href="<c:url value='myPlan'/>">일정보관함</a><br>
	<a href="<c:url value='likeList'/>">좋아요 목록</a><br>
	<a href="<c:url value='writeList'/>">내가 쓴 글 보기</a><br> 
 --%>
